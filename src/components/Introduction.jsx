...
const Introduction = () => {
  ...
  const introduction = portfolioData?.introduction || {};
  ...
  return (
    <section id="about" className="py-24 md:py-32 w-full bg-background border-t border-white/5">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        {/* Left Column - Capsule Images / Videos */}
        <div className="flex justify-center md:justify-start gap-4 md:gap-8 items-center h-[500px] md:h-[600px] order-2 lg:order-1">
          <motion.div 
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="w-[45%] md:w-[220px] h-[90%] pill-shape overflow-hidden grayscale hover:grayscale-0 transition-all duration-500"
          >
            <MediaRenderer
          ...
          <motion.div 
            ...
            className="w-[45%] md:w-[220px] h-[70%] pill-shape overflow-hidden grayscale hover:grayscale-0 transition-all duration-500 mt-10"
          >
            <MediaRenderer 
